...
with open('asset-attribute-predefine.csv', mode='r', encoding='utf-8-sig') as csv_file:
    ...
    for row in csv_reader:
        ...
        account = {
            ...
            'characteristic_value': row["characteristic_value"]
        }

        line_count += 1
        # print(json.dumps(account))
        # print(f'Processed {account} lines.')
        r = requests.post('https://airsel-rfid-api.pipe.my/v1/asset-attribute-predefine/', data=account)
