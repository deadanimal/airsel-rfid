    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.CharField(default='NA', max_length=100)),
                ...
                ('user_type', models.CharField(choices=[('AM', 'Asset Management System'), ('IV', 'Inventory'), ('OP', 'Operator'), ('SK', 'Store Keeper'), ('SS', 'Store Supervisor'), ('TC', 'Technical Crew'), ('VD', 'Vendor')], default='TC', max_length=2)),
