...
#     # id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
#     # ORGANIZATION_CODEA3 = models.IntegerField(blank=True, default='0')
#     # SOURCE_CODE = models.CharField(max_length=300, default='')
#     # SOURCE_HEADER_ID = models.CharField(max_length=100, default='')
#     # TRANSACTION_DATE = models.CharField(max_length=100, default='')
#     # SOURCE_LINE_ID = models.CharField(max_length=22, default='')
#     # TRANSACTION_COST_IDENTIFIER = models.CharField(max_length=100, default='')
#     # ITEM_NUMBER = models.CharField(max_length=40, default='')
#     # SUBINVENTORY_CODE = models.DateTimeField(auto_now=True)
#     # TRANSACTION_QUANTITY = models.CharField(max_length=18, default='')
#     # TRANSACTION_UOM = models.CharField(max_length=18, default='')
#     # TRANSACTION_TYPE_NAME = models.CharField(max_length=18, default='')
#     # TRANSACTION_REFERENCE = models.CharField(max_length=18, default='')
#     # USE_CURRENT_COST = models.CharField(max_length=18, default='')
#     # COST_COMPONENT_CODE = models.CharField(max_length=18, default='')
#     # COST = models.CharField(max_length=18, default='')
