...
export const StoreSupervisorRoutes: Routes = [
  {
    path: "",
    children: [
      {
      ...
      },
      {
        ...
        loadChildren: () => import("./inter-warehouse-transfer/inter-warehouse-transfer.module").then(m => m.InterWarehouseTransferPageModule)
      },
      {
        path: "reversal",
        loadChildren: () => import("./reversal/reversal.module").then(m => m.ReversalPageModule)
      },
      {
        path: "qr-scanner",
