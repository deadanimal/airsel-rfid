(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~asset-management-asset-management-module~big-data-big-data-module~core-admin-admin-module"],{
...
var AssetsService = /** @class */ (function () {
    ...
    AssetsService.prototype.getOne = function (id) {
        var _this = this;
    ...
    AssetsService.prototype.update = function (id, body) {
    ...
    AssetsService.prototype.filter = function (field) {
    ...
    AssetsService.prototype.exportExcel = function (body) {
        var HTTPOptions = {
            'responseType': 'blob'
        };
        return this.http.post(this.url + "exportExcel/", body, HTTPOptions);
    };
...
//# sourceMappingURL=default~asset-management-asset-management-module~big-data-big-data-module~core-admin-admin-module.js.map